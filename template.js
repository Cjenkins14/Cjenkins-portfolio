const STORE = {
    ...
    about an obscure island in the Great Lakes. This was inspired by a summer I spent working there. <br>
    Utilizing:</p>
        <div class="languages">
            <img src="images/html5.png" class="lang-icon" alt="HTML5 icon"></a>
            <img src="images/css3.png" class="lang-icon" alt="CSS3 icon"></a>
            <img src="images/javascipt.png" class="lang-icon" alt="Javascript icon"></a>
            <img src="images/jQuery.png" class="lang-icon" alt="jQuery icon"></a>
        </div>
    <a href="https://cjenkins14.github.io/Mack-quiz-app/
    ">Live Site</a>
    ...
    traveling, enjoying time outdoors, or writing poetry.</p>
      <div class="contact">
        <p>If you have any questions, or are interested in how I may help you, please feel free to contact me via one of these options:</p>
          ...
          <a href="www.linkedin.com/in/coreyjenkins2414"><img src="images/linkedin (1).png"/></a>
          <a href="https://github.com/Cjenkins14"><img src="images/github.jpeg"/></a>
      </div>
    </div>
    `,
    ...
    <button type="button" class="js-view-proj">See Projects</button>
</div>`
};